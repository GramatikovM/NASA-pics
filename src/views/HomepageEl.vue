...
import BaseAppExample from '@/components/BaseAppExample.vue'
import { HOMEPAGE_DATA } from '../contants'
</script>

<template>
  <div class="container">
    <h1 class="home-title">
      Welcome to the place where you can find some of NASA's latest imagery.
    </h1>
    <BaseAppExample
